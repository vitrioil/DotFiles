...
# Replacing colors
sed -i -e 's/bg = .*/bg = #170338/g' $PDIR/colors.ini
sed -i -e 's/fg = .*/fg = #c4cad4/g' $PDIR/colors.ini
sed -i -e 's/ac = .*/ac = #200638/g' $PDIR/colors.ini
sed -i -e 's/bi = .*/bi = #ffffff/g' $PDIR/colors.ini
sed -i -e 's/be = .*/be = #000000/g' $PDIR/colors.ini
sed -i -e 's/mb = .*/mb = #300b70/g' $PDIR/colors.ini
sed -i -e 's/mgf = .*/mgf = #300b70/g' $PDIR/colors.ini
